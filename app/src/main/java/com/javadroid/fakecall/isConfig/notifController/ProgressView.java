...
public class ProgressView extends View {
    ...
    public ProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        context.getTheme().resolveAttribute(com.bumptech.glide.R.attr.colorAccent, outValue, true);
        mForegroundColor = outValue.data;
        context.getTheme().resolveAttribute(com.bumptech.glide.R.attr.color, outValue, true);
